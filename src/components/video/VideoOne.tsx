...
export function VideoOne({ src }: VideoOneProps) {
  useEffect(() => {
  ...
  return (
    <Link
      className="popup_video video_play_button video-play-btn position-absolute top-50 start-50 translate-middle p-0"
      href={src}
    >
      <svg
